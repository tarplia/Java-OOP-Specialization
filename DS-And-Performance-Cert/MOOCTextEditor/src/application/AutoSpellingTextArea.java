...
public class AutoSpellingTextArea extends StyledTextArea<Boolean> {
    ...
    static {
        try {
            mHit =
                    Class.forName("org.fxmisc.richtext.skin.StyledTextAreaView")
                            .getDeclaredMethod("hit", double.class, double.class);
            mGetCharacterIndex =
                    Class.forName("org.fxmisc.richtext.skin.CharacterHit")
    ...
    public AutoSpellingTextArea(
            spelling.AutoComplete ac, spelling.SpellingSuggest ss, spelling.Dictionary dic) {
        super(
                true,
                (textNode, correct) -> {
    ...
    /**
     * Gets white space delimited word which contains character at pos in text Also sets startIndex
     * and endIndex instance variables.
     *
