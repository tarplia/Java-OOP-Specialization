...
public class TextProController {
    ...
    private void initialize() {
        ...
        textBox =
                new AutoSpellingTextArea(
                        launch.getAutoComplete(), launch.getSpellingSuggest(dic), dic);
    ...
    private void handleMarkovText() {
        ...
        Task<textgen.MarkovTextGenerator> task =
