...
public class TrieGrader {
    ...
    private void testAddWords(AutoCompleteDictionaryTrie ac) {
        ...
        appendTestString(
                3, "Adding more words to dictionary trie (testing size after insertions)...");
    ...
    private void testWordsInOut(AutoCompleteDictionaryTrie ac) {
        ...
        feedback.append(
                "'test' in dictionary: "
                        + ac.isWord("test")
                        + ". 'testcases' in dictionary: "
                        + ac.isWord("testcases")
                        + ". 'testone' in dictionary: "
                        + ac.isWord("testone")
                        + ".");
    ...
    private void testPredictions(AutoCompleteDictionaryTrie ac) {
        ...
        feedback.append(
                "Out of 'testone', 'testine', 'testell', and 'testing', "
                        + count
                        + " words were found.");
    }
